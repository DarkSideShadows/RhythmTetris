...
/* stores static data that we will reference throughought the game (cannot instantiate class, can only access data) */
public static class Data
{
    ...
    {
        /* key value pairs: key is piece, value is array of cells */
    ...
    /* when rotating, we might put the piece out of bounds */
